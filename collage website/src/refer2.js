...
function NavScrollExample() {
 ...
 <Container>
    ...
    <div style={{padding:'30px',margin:'30px',backgroundColor: 'lavender',display:'flex',justifycontent:'space-evenly'}}>
     ...
     <h1 style={{ textAlign: 'center',background:'plum' }}>PORFOLIO OF EINSTEIN EQUATIONS</h1>
      ...
      <Row>
        <Col xs={12} md={8}>
           <Image         width={300}
        height={300} src="https://live-production.wcms.abc-cdn.net.au/7d281cbed1fa6b253e3cb6be00223a50?impolicy=wcms_crop_resize&cropH=562&cropW=1000&xPos=0&yPos=0&width=862&height=485" rounded />
        </Col>
        <Col xs={6} md={4}>
        <Image         width={300}
     ...
     /* <Row style={{margin:'50px'}}>
        <Col xs={6} md={4} >
        <Image         width={300}
        height={300} src="https://wp.scoopwhoop.com/wp-content/uploads/2021/10/615551bf8a373a1f9294e9a1_94c699b5-26f0-4677-8e78-334fb47b7f2c.jpg" rounded />        </Col>
        ...
        <Image         width={300}
        height={300} src="https://pbs.twimg.com/media/DXy6x7WWsAIzd6w.jpg:large" rounded />        </Col>
      </Row>
